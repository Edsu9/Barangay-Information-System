    ...
    <div class="dashboard-container">
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-menu">
                ...
                <a href="residents.php" class="menu-item <?php echo basename($_SERVER['PHP_SELF']) == 'residents.php' || strpos($_SERVER['PHP_SELF'], 'resident') !== false ? 'active' : ''; ?>">
                    <i class="fas fa-users"></i> Residents
                </a>
                <a href="households.php" class="menu-item <?php echo basename($_SERVER['PHP_SELF']) == 'households.php' || strpos($_SERVER['PHP_SELF'], 'household') !== false ? 'active' : ''; ?>">
                    <i class="fas fa-home"></i> Households
                </a>
                <a href="documents.php" class="menu-item <?php echo basename($_SERVER['PHP_SELF']) == 'documents.php' || strpos($_SERVER['PHP_SELF'], 'document') !== false ? 'active' : ''; ?>">
                ...
                <a href="users.php" class="menu-item <?php echo basename($_SERVER['PHP_SELF']) == 'users.php' || strpos($_SERVER['PHP_SELF'], 'user') !== false ? 'active' : ''; ?>">
